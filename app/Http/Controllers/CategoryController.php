...
class CategoryController extends Controller
{
   ...
   public function AuthLogin(){
    ...
    public function add_category(){
        $this->AuthLogin();
        return view('admin.page.add-category-product');
     }
     public function all_category(){
        $this->AuthLogin();
      $show_all_products= $this->var_category->Show_all_category();
        return view('admin.page.all-category-product')->with('show_all_products',$show_all_products);
     }
     public function save_category(Request $request){
      ...
      if ($get_img) {
          ...
          $new_image = $name_img;
          $get_img->move('public/upload/categoryImage/',$new_image);
     ...
     $edit_category_product = $this->var_category->Edit_category($category_product_id);
      $manager_category_product = view('admin.page.edit-category')->with('edit_category_product',$edit_category_product);
       return view('adminlayout')->with('admin.page.edit-category',$manager_category_product);
