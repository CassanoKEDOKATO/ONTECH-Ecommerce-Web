...
class BrandController extends Controller
{
   ...
   public function AuthLogin(){
    ...
    public function add_brand(){
        $this->AuthLogin();
        return view('admin.page.add-brand-product');
     }
     public function all_brand(){
        $this->AuthLogin();
      $show_all_products= $this->var_brand->Show_all_brand();
        return view('admin.page.all-brand-product')->with('show_all_products',$show_all_products);
     }
     public function save_brand(Request $request){
      ...
      if ($get_img) {
          ...
          $new_image = $name_img;
          $get_img->move('public/upload/brandImage/',$new_image);
     ...
     $edit_brand_product = $this->var_brand->Edit_brand($brand_product_id);
      $manager_brand_product = view('admin.page.edit-brand')->with('edit_brand_product',$edit_brand_product);
       return view('adminlayout')->with('admin.page.edit-brand',$manager_brand_product);
