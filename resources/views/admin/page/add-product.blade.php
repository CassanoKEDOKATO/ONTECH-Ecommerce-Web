                            ...
                            <div class="row">
                               <div class=" col-md-9 col-lg-9">
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="Name" type="text" name="product_name" class="form-control" placeholder="Tên danh mục">
                                </div>
                                ...
                                <div class="form-group form-group-default">
                                    <label>Ảnh-1</label>
                                    <input id="Name" type="file" name="product_image" class="form-control" placeholder="Fill Name">
                                </div>
                                <div class="form-group form-group-default">
                                    <label>Ảnh-2</label>
                                    <input id="Name" type="file" name="product_image2" class="form-control" placeholder="Fill Name">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nội dung</label>
                                    <textarea name="product_content" class="form-control"  rows="4"></textarea>
                                </div>
                                <div class="form-group ">
