            ...
            <div class="sidebar-filter">
               ...
               <div class="sidebar-widget">
                  ...
                  <div class="sidebar-widget-body m-t-10">
                     <div class="price-range-holder"> <span class="min-max"> <span class="pull-left">5.00.000</span> <span class="pull-right">20.000.000</span> </span>
                     ...
                     <div class="lbl-cnt">
                        ...
                        <div class="fld inline">
                           <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                              {{-- <button data-toggle="dropdown" type="button" class="btn dropdown-toggle">--Lọc--<span class="caret"></span> </button>
                              <ul role="menu" class="dropdown-menu">
                                 <li role="presentation"><a href="#">Giá tăng dần </a></li>
                                 <li role="presentation"><a href="#">Giá giảm dần</a></li>
                                 <li role="presentation"><a href="#">Tên sản phẩm A tới Z</a></li>
                                 <li role="presentation"><a href="#">Tên sản phẩm Z tới A</a></li>
                              </ul> --}}
                              <form>
                                 @csrf
                                 ...
                                 <div class="product">
                                    <div class="product-image">
                                       <div class="image"> 
                                          ...
                                          <img src="{{asset('public/upload/productImage/'.$product->product_image)}}" alt=""  class="hover-image"> 
                                          </a> 
                                       </div>
                                       <!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                       <h3 class="nameshop"><a href="{{URL::to('chi-tiet-san-pham/'.$product->product_id)}}">{{$product->product_name}}</a></h3>
                                       <div class="rating rateit-small"></div>
                                       <div class="description"></div>
                                       <div class="product-price"> <span class="price"> {{number_format($product->product_price)}}  VND</span> <span class="price-before-discount">$ 800</span> </div>
                                       <!-- /.product-price --> 
                                    </div>
                                    <!-- /.product-info -->
