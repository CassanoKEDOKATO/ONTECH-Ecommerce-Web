                        ...
                        <ul class="dropdown-menu mega-menu">
                           <li class="yamm-content">
                              <div class="row">
                                 <div class="col-sm-12 col-md-3">
                                    <ul class="links list-unstyled">
                                       <li><a href="#"><b>MÀN HÌNH THEO KÍCH THƯỚC</b></a></li>
                                       <li><a href="#">Màn Hình 19 inch</a></li>
                                       <li><a href="#">Màn Hình 21.5 inch</a></li>
                                       <li><a href="#">Màn Hình 23 inch</a></li>
                                       <li><a href="#">Màn Hình 24 inch</a></li>
                                       <li><a href="#">Màn Hình 25 inch</a></li>
                                       <li><a href="#">Màn Hình 27 inch</a></li>
                                    </ul>
                                 </div>
                                 <!-- /.col -->
                                 <div class="col-sm-12 col-md-3">
                                    <ul class="links list-unstyled">
                                       <li><a href="#"><b>ĐỘ PHÂN GIẢI MÀN HÌNH</b></a></li>
                                       <li><a href="#">HD (1366x768)</a></li>
                                         <li><a href="#">HD+ (1600x900)</a></li>
                                         <li><a href="#"> Full HD (1920x1080)</a></li>
                                        <li><a href="#">DualQHD (5120x1440)</a></li>
                                 ...
                                 <div class="col-sm-12 col-md-3">
                                    <ul class="links list-unstyled">
                                       <li><a href="#"><B>TẦN SỐ MÀN HÌNH</B></a></li>
                                       <li><a href="#">60Hz</a></li>
                                       <li><a href="#">75Hz</a></li>
                                       <li><a href="#">120Hz</a></li>
                                       <li><a href="#">144Hz</a></li>
                                       <li><a href="#">165Hz</a></li>
                                    </ul>
                                 </div>
                                 <!-- /.col -->
                                 <div class="col-sm-12 col-md-3">
                                    <ul class="links list-unstyled">
                                       <li><a href="#"><b>NHU CẦU SỬ DỤNG</b></a></li>
                                       <li><a href="#">Gaming</a></li>
                                       <li><a href="#">thiết kế độ hoạ</a></li>
                                       <li><a href="#">Phổ thông văn phòng</a></li>
                                    </ul>
                                 </div>
                                 <!-- /.col --> 
                              </div>
         ...
         <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
            ...
            <div id="hero">
               <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                  ...
                  <div class="item" style="background-image: url(public/upload/sliderImage/$value_slider->slide_image);" >
                  ...
                  @foreach ($slider as $key => $value_slider)
                  <div class="col-sm-12">
                     <img alt="{{$value_slider->slider_desc}}" src="{{asset('public/upload/sliderImage/'.$value_slider->slider_image)}}" height="200" width="100%" class="img img-responsive">
                                 ...
                                 <div class="product">
                                    <div class="product-image">
                                       <div class="image"> 
                                          ...
                                          <img src="{{asset('public/upload/productImage/'.$show_all_products->product_image2)}}" alt="" class="hover-image">
                                          </a> 
                                       </div>
                                       <!-- /.image -->
                                    ...
                                    <div class="product-image">
                                       <div class="image"> 
                                          <a href="{{URL::to('chi-tiet-san-pham/'.$value_laptop->product_id)}}">
                                             ...
                                             <img src="{{asset('public/upload/productImage/'.$value_laptop->product_image2)}}" alt="" class="hover-image">
                                    ...
                                    <div class="cart clearfix animate-effect">
                                       <div class="action">
                                          <ul class="list-unstyled">
                                             ...
                                             <li class="lnk wishlist"> <a class="add-to-cart"  title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                        ...
                        <div class="product">
                           <div class="product-image">
                              <div class="image"> 
                                 ...
                                 <img id="wishlist_productimage{{$value_monitor->product_id}}" src="{{asset('public/upload/productImage/'.$value_monitor->product_image)}}" alt=""> 
                                 <img src="{{asset('public/upload/productImage/'.$value_monitor->product_image2)}}"alt="" class="hover-image">
                                 </a>
                              </div>
                              <!-- /.image -->
                              <div class="tag new"><span>new</span></div>
                           ...
                           <!-- /.product-image -->
                           <div class="product-info text-left">
                              <h3 class="name"><a  id="wishlist_producturl{{$value_monitor->product_id}}" href="{{URL::to('chi-tiet-san-pham/'.$value_monitor->product_id)}}">{{$value_monitor->product_name}}</a></h3>
                              <div class="rating rateit-small"></div>
                              <div class="description"></div>
                           ...
                           <div class="cart clearfix animate-effect">
                              <div class="action">
                                 <ul class="list-unstyled">
                                    ...
                                    <input type="hidden" id="wishlist_productname{{$value_monitor->product_id}}" value="{{$value_monitor->product_name}}" class="cart_product_name_{{$value_monitor->product_id}}">
                                    <input type="hidden" id="wishlist_productprice{{$value_monitor->product_id}}" value="{{number_format($value_monitor->product_price)}}" class="cart_product_price_{{$value_monitor->product_id}}">
                                    {{-- <input type="hidden" id="wishlist_productimage{{$value_monitor->product_id}}"  src="{{asset('public/upload/productImage/'.$value_monitor->product_image)}}" class="">
                                    <input type="hidden" id="wishlist_producturl{{$value_monitor->product_id}}"  href="{{URL::to('chi-tiet-san-pham/'.$value_monitor->product_id)}}"  class=""> --}}

                                    <li class="lnk wishlist"> <button class="button_wishlist"  id="{{$value_monitor->product_id}}" onclick="add_wishlist(this.id);" title="Wishlist"> <i class="icon fa fa-heart"></i> </button> </li>
                                    <li class="lnk"> <a class="add-to-cart" data-toggle="modal" data-target="#myModal"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
   ...
   <div class="modal-dialog" role="document">
     <div class="modal-content">
       ...
       <div class="modal-body">
         @foreach ($monitor as $key => $value_monitor)
         <h1>{{$value_monitor->product_name}}</h1>
        @endforeach
       </div>
                           ...
                           <div class="cart clearfix animate-effect">
                              <div class="action">
                                 <ul class="list-unstyled">
                                    ...
                                    <li class="lnk wishlist"> <button class="button_wishlist"  title="Wishlist"> <i class="icon fa fa-heart"></i> </button> </li>
                                    <li class="lnk"> <a class="add-to-cart" href="detail.html" title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                                 </ul>
                              </div>
                              <!-- /.action --> 
               ...
               <div class="blog-slider-container outer-top-xs">
                  <div class="owl-carousel blog-slider custom-carousel">
                     ...
                     <div class="item">
                        <div class="blog-post">
                           <div class="blog-post-image">
                              <div class="image"> <a href="blog.html"><img src="{{('public/upload/blogImage/'.$blog->blog_image)}}" alt=""></a> </div>
                           </div>
                           <!-- /.blog-post-image -->
                           <div class="blog-post-info text-left">
               ...
               <div class="blog-slider-container outer-top-xs">
                  <div class="owl-carousel blog-slider custom-carousel">
                     ...
                     <div class="item">
                        <div class="blog-post">
                           <div class="blog-post-image">
                              <div class="image"> <a href="blog.html"><img src="{{asset('public/upload/brandImage/'.$brand_value->brand_image)}}" alt="" width="100" height="200"></a> </div>
                           </div>
                           <!-- /.blog-post-image -->
                        </div>
                        <!-- /.blog-post --> 
