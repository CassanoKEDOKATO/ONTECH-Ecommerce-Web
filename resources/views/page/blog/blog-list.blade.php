      ...
      <div class="row">
         <div class="blog-page">
            <div class="col-xs-12 col-sm-9 col-md-9 rht-col">
				@foreach ($all_blog as $key => $value_blog)
					
			
               <div class="blog-post  wow fadeInUp">
                  <a href="{{URL::to('blog-detail/'.$value_blog->blog_id)}}"><img class="img-responsive" src="{{asset('public/upload/blogImage/'.$value_blog->blog_image)}}" alt=""></a>
                  <h1><a href="{{URL::to('blog-detail/'.$value_blog->blog_id)}}">{{$value_blog->blog_title}}</a></h1>
